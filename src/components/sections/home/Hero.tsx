        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              Certified SAP Gold Partner - S/4HANA Ready
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Streamline operations, boost efficiency, and accelerate growth with our expert SAP
              consulting and integration services. From S/4HANA migrations to custom module
              implementations.
            </p>
