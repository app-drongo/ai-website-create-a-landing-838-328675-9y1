...
export default function Cta() {
  ...
  const handleSecondaryAction = () => {
    router.push('/'); // View integration portfolio
  };
  ...
  const stats = [
    ...
    { value: '50+', label: 'ERP Modules', icon: Zap },
    { value: '24/7', label: 'System Monitoring', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Streamline operations, boost efficiency, and drive growth with our expert SAP
                integration services. From S/4HANA migrations to custom module implementations.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Comprehensive SAP readiness assessment at no cost
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SAP Gold Partner with 15+ years of implementation experience
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Accelerated go-live with our proven implementation methodology
              </p>
            </div>
          </div>
        </div>
